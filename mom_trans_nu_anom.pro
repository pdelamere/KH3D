...
files=['./run1_3d/','./run6_3d/','./run7_3d/'];,'./run4_3d/','./run5_3d/','./run6_3d/','./run7_3d/','./run8_3d/']
...
;ntot = 109.*99.
   ...
   for i = 1,16 do begin
      mom_trans,files(nf),i,60,rhouu,bb,TM,TR,x,y,w,dt,omega_p,dudz,rho0,dV0,coverwpi
...
;stop
   ...
   maxnu_rhouu = [maxnu_rhouu,max(abs(nu_anom_rhouu))]
